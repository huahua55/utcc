...
<head>
    <meta charset="UTF-8">
    <title>test</title>
    <link href="<?php echo _url('/static/bootstrap/css/bootstrap.min.css') ?>"  rel="stylesheet">
    <script src="<?php echo _url('/static/jquery-1.9.1.min.js') ?>"></script>
    <script src="<?php echo _url('/static/webuploader/webuploader.js') ?>"></script>
    <style>
...
<script type="text/javascript">
    $(function () {
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: 'http://utcc.video.com/upload/',
            // 选择文件的按钮。可选。
